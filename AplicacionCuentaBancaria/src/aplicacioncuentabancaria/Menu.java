...
System.out.println("<<<<<<<<<<<<>>>>>>>>>>>>");
        ...
        System.out.println("5. Ver el número de la cuenta (solamente el número de cuenta, sin entidad, oficina ni\n" +
"dígitos de control).");
        System.out.println("6. Ver los dígitos de control de la cuenta.");
        System.out.println("7. Realizar un ingreso. Habrá que solicitar por teclado la cantidad que se desea\n" +
"ingresar.");
